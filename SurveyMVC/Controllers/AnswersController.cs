...
namespace SurveyMVC.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ResponseId = new SelectList(db.Responses, "Id", "EmployeeId");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,AnswerDetails,ResponseId,QuestionId")] Answer answer)
        {
            ...
            ViewBag.QuestionId = new SelectList(db.Questions, "Id", "QuestionDetails", answer.QuestionId);
            ViewBag.ResponseId = new SelectList(db.Responses, "Id", "EmployeeId", answer.ResponseId);
            return View(answer);
        }
